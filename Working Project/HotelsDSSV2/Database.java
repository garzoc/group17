   ...
   public Database() {
	...
	try{
	   Class.forName("org.sqlite.JDBC");
		...
		connection=DriverManager.getConnection("jdbc:sqlite:"+Properties.getProperty("databasePath")+"/Hotels.sqlite");
		statement=connection.createStatement();			
		String sql = " CREATE TABLE Hotels("+
	    "HID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL UNIQUE,"+
	  "Name TEXT,"+
	"Address TEXT,"+
	"Price DOUBLE,"+
	"Stars INTEGER,"+
